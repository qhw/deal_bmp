...
#ifdef DLL_FILE
class _declspec(dllexport) BMFH  //导出类circle
#else
class _declspec(dllimport) BMFH  //导入类circle
#endif
{
public:
 ebmpWORD  bfType;
...
#ifdef DLL_FILE
class _declspec(dllexport) BMIH  //导出类circle
#else
class _declspec(dllimport) BMIH  //导入类circle
#endif
{
public:
 ebmpDWORD biSize;
