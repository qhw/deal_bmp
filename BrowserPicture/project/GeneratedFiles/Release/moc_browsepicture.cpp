...
static const char qt_meta_stringdata_BrowsePicture[] = {
    "BrowsePicture\0\0Cancel_Btn()\0"
    "OpenActTriggered()\0ExitActTriggered()\0"
    "OpenButtonClicked()\0SplitButtonClicked()\0"
    "OpenDirButtonClicked()\0ShowPicButtonClicked()\0"
    "AutoMergeButtonClicked()\0filename,arg\0"
    "splitPic(QString,SPLITArg)\0"
...
int BrowsePicture::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: Cancel_Btn(); break;
        case 1: OpenActTriggered(); break;
        case 2: ExitActTriggered(); break;
        case 3: OpenButtonClicked(); break;
        case 4: SplitButtonClicked(); break;
        case 5: OpenDirButtonClicked(); break;
        case 6: ShowPicButtonClicked(); break;
        case 7: AutoMergeButtonClicked(); break;
        case 8: splitPic((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< const SPLITArg(*)>(_a[2]))); break;
        case 9: ShowDonePicture((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 10: doneSuccess(); break;
        case 11: doneFail(); break;
        case 12: { bool _r = ShowThumbnail((*reinterpret_cast< QString(*)>(_a[1])));
